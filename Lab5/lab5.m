...
P_A_P_ETable(7,1) = a7(:,44);
P_A_P_ETable(7,2) = a7(:,45);
P_A_P_ETable(8,1) = a8(:,44);
P_A_P_ETable(8,2) = a8(:,45);
...
angle = [-4, 0, 4, 8, 10, 12, 14, 16];
% for i = 1:8
%     figure(i)
%     plot(coords(1:21),C_P(1:21,i))
%     hold on
%     plot(coords(21:43),C_P(21:43,i),'r')
...
for i = 1:8 %calculating coefficients
